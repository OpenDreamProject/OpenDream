...
To build, one can use a C# compiler (such as MSBuild) to compile the various projects described in the solution. To us MSBuild, simply run `dotnet build` in the OpenDream directory. This will build all of the solutions and put the resultant binaries in `bin`
