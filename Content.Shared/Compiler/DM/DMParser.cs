...
using DereferenceType = Content.Shared.Compiler.DM.DMASTDereference.DereferenceType;
using Dereference = Content.Shared.Compiler.DM.DMASTDereference.Dereference;
