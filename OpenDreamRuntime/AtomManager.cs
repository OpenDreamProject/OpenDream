...
public sealed class AtomManager {
    ...
    public void AnimateAppearance(DreamObjectAtom atom, TimeSpan duration, AnimationEasing easing, int loop, AnimationFlags flags, int delay, Action<IconAppearance> animate) {
        ...
        AppearanceSystem.Animate(ent, appearance, duration, easing, loop, flags, delay);
    }
