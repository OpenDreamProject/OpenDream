...
public sealed class DreamObjectTree {
    ...
    private AsyncNativeProc CreateAsyncNativeProc(TreeEntry owningType, Func<AsyncNativeProc.AsyncDMProcState, Task<DreamValue>> func) {
        var (name, defaultArgumentValues, argumentNames) = NativeProc.GetNativeInfo(func);
    ...
    public void SetGlobalNativeProc(Func<AsyncNativeProc.AsyncDMProcState, Task<DreamValue>> func) {
        var (name, defaultArgumentValues, argumentNames) = NativeProc.GetNativeInfo(func);
    ...
    public void SetNativeProc(TreeEntry type, Func<AsyncNativeProc.AsyncDMProcState, Task<DreamValue>> func) {
