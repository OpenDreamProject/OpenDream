...
{
    static public class DMObjectTree {
        ...
        static internal void AddGlobalInitProcAssign(Expressions.Assignment assign) {
        ...
        public static DreamCompiledJson SaveJson(List<DreamMapJson> maps, string interfaceFile)
        {
