...
public enum WarningCode {
    ...
    AmbiguousVarStatic = 2212, // Assigning an instance variable to a static one (which gives unknown ref) while a global exists (which makes it work, with unexpected value)
    MalformedRange = 2300,
    InvalidRange = 2301,
