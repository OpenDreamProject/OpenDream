...
internal class AnnotatedByteCodeWriter {
    ...
    /// <param name="location">The location of the filter in the source code</param>
    ///
    public void WriteFilterTypeId(DMValueType filterPaths, Location location) {
        _location = location;
        ...
        _annotatedBytecode[^1].AddArg(new AnnotatedBytecodeTypeFilter(1, filterPaths, location));
    }
