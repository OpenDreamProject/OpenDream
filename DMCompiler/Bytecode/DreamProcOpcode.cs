...
public enum DreamProcOpcode : byte {
    ...
    [OpcodeMetadata(0, splitsBasicBlock: true, requiredArgs: new[] { OpcodeArgType.String, OpcodeArgType.ArgType, OpcodeArgType.StackDelta })]
...
internal sealed class OpcodeMetadataAttribute : Attribute {
    ...
    public OpcodeMetadataAttribute(int stackDelta = 0, bool splitsBasicBlock = false, params OpcodeArgType[] requiredArgs) {
        Metadata = new OpcodeMetadata(stackDelta, splitsBasicBlock, requiredArgs);
    }
}
...
public struct OpcodeMetadata {
    ...
    public OpcodeMetadata(int stackDelta = 0, bool splitsBasicBlock = false, params OpcodeArgType[]
    requiredArgs) {
