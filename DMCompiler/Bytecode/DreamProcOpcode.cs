...
public enum DreamProcOpcode : byte {
    ...
    [OpcodeMetadata(0, requiredArgs: new[] { OpcodeArgType.String, OpcodeArgType.FormatCount })]
    FormatString = 0x4,
    ...
    [OpcodeMetadata(0, requiredArgs: new[] { OpcodeArgType.Reference, OpcodeArgType.Reference })]
    Input = 0x1C,
...
public struct OpcodeMetadata {
    ...
    public OpcodeMetadata(int stackDelta = 0, bool splitsBasicBlock = false, params OpcodeArgType[] requiredArgs) {
